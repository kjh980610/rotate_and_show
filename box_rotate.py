...
def box_rotate(current_pose,rotate_pose) :
    ...
    def get_joint_pathes(current_pose,rotate_pose):
        ...
        target_offset = np.array([0.6, 0, table_height + abs(red_cube_mesh.bounds[0][2])+0.074])
    ...
    joint_pathes = get_joint_pathes(current_pose,rotate_pose)
